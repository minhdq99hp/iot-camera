...
default_anchors_path = '/home/minhdq99hp/iot-camera/minh_custom_keras_yolo3/model_data/yolo_anchors.txt'
default_classes_path = '/home/minhdq99hp/iot-camera/minh_custom_keras_yolo3/model_data/classes.txt'
default_font_path = '/home/minhdq99hp/iot-camera/minh_custom_keras_yolo3/font/FiraMono-Medium.otf'
...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font=default_font_path,
    ...
    def detect_person(self, image):
        ...
        font = ImageFont.truetype(font=default_font_path, size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
        thickness = (image.size[0] + image.size[1]) // 300
        ...
        # DRAW COUNT TEXT
        count_font = ImageFont.truetype(font=default_font_path, size=np.floor(3e-2 * image.size[1]*2 + 0.5).astype('int32'))
        draw = ImageDraw.Draw(image)
